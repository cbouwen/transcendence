class PongGame {
	...
	draw() {
		...
		// Draw Mid-Line and Scores
		this.drawMidLineAndScores();
	}

	drawMidLineAndScores() {
	...
	listen() {
		document.addEventListener('keydown', (key) => {
			...
			if (key.keyCode === 38 || key.keyCode === 87) this.player.move = this.DIRECTION.UP;
			if (key.keyCode === 40 || key.keyCode === 83) this.player.move = this.DIRECTION.DOWN;
		});

		document.addEventListener('keyup', () => this.player.move = this.DIRECTION.IDLE);
	}
